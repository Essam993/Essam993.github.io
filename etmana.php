    ...
    <div class="ajax-page-wrapper">
        <div class="ajax-page-nav">
            <div class="nav-item ajax-page-prev-next">
                <a class="ajax-page-load" href="dashboard.php"><i class="pe-7s-icon pe-7s-angle-left"></i></a>
        ...
        <div class="row">
            <div class="col-sm-7 col-md-7 portfolio-block">
                <div class="owl-carousel portfolio-page-carousel">
                    ...
                    <div class="item">
                        <img src="images/portfolio/full/etmana2.jpg" alt="">
                    </div>
                    <div class="item">
                        <img src="images/portfolio/full/etmana3.jpg" alt="">
                    </div>
                </div>
            ...
            <div class="col-sm-5 col-md-5 portfolio-block">
                ...
                <ul class="project-general-info">
                    <li><p><i class="fa fa-user"></i>BS Hub</p></li>
                    <li><p><i class="fa fa-globe"></i> <a href="#" target="_blank">www.etmana.com</a></p></li>
                    <li><p><i class="fa fa-calendar"></i> March, 2022</p></li>
                </ul>
